        ...
        <div class="container slider-top-text">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <br>
                    <h4 class="myp-slider text-center "><b>Membuat web menggunakan framework laravel</b></h4>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="bio-content">
                      ...
                      <br>
                      <h5><b>Nama  :</b> Nuri Astutik</h5><h5> <b>Kelas :</b> XII RPL 1</h5><h5> <b>Jurusan    : </b>Rekayasa Perangkat Lunak</h5><h5><b>Sekolah  :</b> SMKN 1 Purwosari</h5><h5> <b>Tempat/Tanggal Lahir    : </b>Pasuruan, 06 Januari 2004</h5>
                      <h5><b>Alamat :</b>  Jl.Makam Purwosari RT 01/RW 04 Kec.Purwosari</h5>
                    </div>
                  </div>
                </div>	
              </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 text-center text-lg-left my-auto  wow zoomIn">
                    ...
                    <p style="color:rgb(0, 0, 0);">* <b>NURI ASTUTIK</b></p>
                    <p style="color:rgb(0, 0, 0);">* <b>XII RPL 1</b></p>
                    <p style="color:rgb(0, 0, 0);">* <b>Rekayasa Perangkat Lunak</b></p>
                </div>
